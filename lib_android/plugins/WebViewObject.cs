...
public class WebViewObject : MonoBehaviour
{
    ...
    {
#if !UNITY_EDITOR && UNITY_ANDROID
        return (new AndroidJavaObject("com.casual.porter.CWebViewPlugin")).CallStatic<bool>("IsWebViewAvailable");
#else
        return true;
#endif
    }
...
#elif UNITY_ANDROID
        webView = new AndroidJavaObject("com.casual.porter.CWebViewPlugin");
